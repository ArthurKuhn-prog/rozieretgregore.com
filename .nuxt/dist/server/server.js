...
module.exports = __webpack_require__.p + "videos/puitsDordogne_2.725b3f2.mp4";
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "body{margin:0;display:flex;flex-direction:column;overflow-y:auto;overflow-x:hidden;color:#fff;font-family:\"Franklin Gothic Medium\",\"Arial Narrow\",Arial,sans-serif}.header{background-color:rgba(0,0,0,.4);height:100vh;width:100%;display:flex;justify-content:center;align-items:center}h1{font-size:75pt}h1,h2{text-align:center;text-shadow:2px #000}h2{font-size:40pt;margin:0 2% 5vh}.latest{background:#fff;color:#000}.contact,.latest{width:100%;min-height:50vh;padding-top:5vh;padding-bottom:5vh}.contact{background:#000;color:#fff;display:flex;flex-direction:row;align-items:center;justify-content:space-around}.contact .description{border-right:2px solid #fff;padding-right:2vw}.contact .contact_links,.contact .description{font-size:40pt;width:30vw}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
const _6c78ff97 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 1).then(__webpack_require__.bind(null, 22)));
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./layouts/default.vue?vue&type=template&id=603687dc&
var defaultvue_type_template_id_603687dc_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<video autoplay=\"autoplay\" muted=\"muted\" loop=\"loop\" style=\"min-height: 100vh;\\n        min-width: 100%;\\n        z-index: -10;\\n        position: fixed;\"><source"+(_vm._ssrAttr("src",__webpack_require__(18)))+" type=\"video/mp4\"></video> "),_c('Nuxt')],2)}
var defaultvue_type_template_id_603687dc_staticRenderFns = []


// CONCATENATED MODULE: ./layouts/default.vue?vue&type=template&id=603687dc&
...
var default_component = Object(componentNormalizer["a" /* default */])(
  ...
  defaultvue_type_template_id_603687dc_render,
  defaultvue_type_template_id_603687dc_staticRenderFns,
  false,
