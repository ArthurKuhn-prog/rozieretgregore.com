...
/******/ 			var chunk = require("./" + ({"1":"pages/about","2":"pages/actus","3":"pages/index","4":"pages/projects/_id","5":"pages/projects/index"}[chunkId]||chunkId) + ".js");
...
module.exports = JSON.parse("[{\"contactID\":0,\"about\":{\"fr\":{\"description\":\"Rozier & Grégore est un duo d'artiste constitué d'Arthur Kuhn et Paul Cottet-Dumoulin, tâchant d'envahir la réalité une histoire à la fois.\"},\"en\":{\"description\":\"Rozier & Grégore is an artist duo made up of Arthur Kuhn and Paul Cottet-Dumoulin claiming reality one story at a time.\"}},\"links\":[{\"id\":0,\"name\":\"instagram\",\"textLink\":\"@rozieretgregore\",\"link\":\"https://www.instagram.com/rozieretgregore\"},{\"id\":1,\"name\":\"mail\",\"textLink\":\"contact@rozieretgregore.com\",\"link\":\"mailto:contact@rozieretgregore.com\"}]}]");
...
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
__webpack_require__(4).default("701f0ef2", content, true)
...
module.exports = __webpack_require__.p + "videos/puitsDordogne_2.61a16d5.webm";

/***/ }),
/* 26 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "videos/puitsDordogneINSTA.0e6aa15.mp4";
...
const _4cc124d2 = () => interopDefault(__webpack_require__.e(/* import() | pages/about */ 1).then(__webpack_require__.bind(null, 36)));

const _85d93b16 = () => interopDefault(__webpack_require__.e(/* import() | pages/actus */ 2).then(__webpack_require__.bind(null, 37)));

const _1b86d488 = () => interopDefault(__webpack_require__.e(/* import() | pages/projects/index */ 5).then(__webpack_require__.bind(null, 38)));

const _3e5058f0 = () => interopDefault(__webpack_require__.e(/* import() | pages/projects/_id */ 4).then(__webpack_require__.bind(null, 39)));

const _6c78ff97 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 3).then(__webpack_require__.bind(null, 40)));
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/default.vue?vue&type=template&id=5e4a534b&
var defaultvue_type_template_id_5e4a534b_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Header'),_vm._ssrNode(" <div class=\"hidden lg:block\"><video autoplay=\"autoplay\" muted=\"muted\" disablePictureInPicture loop=\"loop\" style=\"min-height: 100vh;\\n        object-fit: cover;\\n        z-index: -10;\\n        position: fixed;\"><source"+(_vm._ssrAttr("src",__webpack_require__(25)))+" type=\"video/webm\"></video></div> <div class=\"block lg:hidden\"><video autoplay=\"autoplay\" muted=\"muted\" disablePictureInPicture loop=\"loop\" style=\"min-height: 100vh;\\n        object-fit: cover;\\n        z-index: -10;\\n        position: fixed;\"><source"+(_vm._ssrAttr("src",__webpack_require__(26)))+" type=\"video/mp4\"></video></div> "),_c('Nuxt',{staticClass:"content"}),_vm._ssrNode(" "),_c('Footer')],2)}
var defaultvue_type_template_id_5e4a534b_staticRenderFns = []


// CONCATENATED MODULE: ./layouts/default.vue?vue&type=template&id=5e4a534b&
...
var default_component = Object(componentNormalizer["a" /* default */])(
  ...
  defaultvue_type_template_id_5e4a534b_render,
  defaultvue_type_template_id_5e4a534b_staticRenderFns,
  false,
...
installComponents(default_component, {Header: __webpack_require__(31).default,Footer: __webpack_require__(32).default})
...
const Header = () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 31)).then(c => wrapFunctional(c.default || c)); // nuxt/nuxt.js#8607
...
/* harmony default export */ var dataApi = (function (context, inject) {
  ...
  async function getProject(projectID) {
    try {
      return unwrap(await fetch(`https://${appId}-dsn.algolia.net/1/indexes/projets/${projectID}`, {
        headers
      }));
    } catch (error) {
  ...
  async function getActus(projectID) {
    try {
      return unwrap(await fetch(`https://${appId}-dsn.algolia.net/1/indexes/actus/${projectID}`, {
        headers
      }));
    } catch (error) {
      return getErrorResponse(error);
  ...
  async function getContacts(projectID) {
    try {
      return unwrap(await fetch(`https://${appId}-dsn.algolia.net/1/indexes/contacts/${projectID}`, {
        headers
      }));
    } catch (error) {
      return getErrorResponse(error);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/header.vue?vue&type=template&id=3f130080&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<div class=\"nav-menu-lg hidden lg:flex w-full h-auto justify-between p-5 bg-black fixed top-0\" style=\"border-bottom:1px solid white\">","</div>",[_vm._ssrNode("<div class=\"flex-1\"><button type=\"button\">FR</button>\n            |\n            <button type=\"button\">EN</button></div> "),_vm._ssrNode("<div class=\"flex-none\">","</div>",[_vm._ssrNode("<h1 class=\"text-2xl\">","</h1>",[_c('nuxt-link',{attrs:{"to":"/"}},[_vm._v("Rozier & Grégore")])],1)]),_vm._ssrNode(" <div class=\"flex-1 text-right\">"+((_vm.lang === 'fr')?("<span>Site en construction</span>"):("<span>Website under construction</span>"))+"</div>")],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"nav-menu-sm flex lg:hidden justify-between items-center w-full h-auto text-6xl fixed top-0 bg-black p-8\" style=\"border-bottom:1px solid white\">","</div>",[_vm._ssrNode("<div class=\"flex-none\">","</div>",[_vm._ssrNode("<h1>","</h1>",[_c('nuxt-link',{attrs:{"to":"/"}},[_vm._v("Rozier & Grégore")])],1)]),_vm._ssrNode(" <div><div class=\"m-5\"><button type=\"button\" class=\"mr-4\">FR</button>\n                    |\n                    <button type=\"button\">EN</button></div></div>")],2)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/header.vue?vue&type=template&id=3f130080&
...
/* harmony default export */ var headervue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    showMenuMob() {
      if (this.menuMob) this.menuMob = false;else this.menuMob = true;
    }
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/footer.vue?vue&type=template&id=3fd95254&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"contact flex flex-col lg:flex-row justify-around items-center bg-black",staticStyle:{"border-top":"1px solid white"}},[_vm._ssrNode("<p class=\"lg:w-3/5 m-8 text-6xl leading-relaxed lg:text-5xl\">"+_vm._ssrEscape(_vm._s(_vm.contacts.about[_vm.lang].description))+"</p> <div>"+(_vm._ssrList((_vm.contacts.links),function(link){return ("<p class=\"lg:w-2/5 m-8 text-6xl leading-relaxed lg:text-4xl\">"+_vm._ssrEscape(_vm._s(link.name)+" : ")+"<a"+(_vm._ssrAttr("href",link.link))+">"+_vm._ssrEscape(_vm._s(link.textLink))+"</a></p>")}))+"</div>")])}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/footer.vue?vue&type=template&id=3fd95254&
